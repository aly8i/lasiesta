...
export default AuthorizedGet( async function handler(req, res) {
  ...
  if (method === "POST") {
    ...
    try {
      ...
      setCookie('accessToken',access,{req,res,maxAge: process.env.NEXT_PUBLIC_COOKIE_AGE,path:'/',httpOnly:true,domain:`${process.env.NEXT_PUBLIC_BASE_URL}`,sameSite:"strict"});
